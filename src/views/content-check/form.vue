<template>
  ...
  >
    <el-form ref="refForm" label-width="250px" :inline="false" :model="subForm" :rules="formRules" class="pr-5">
      <el-form-item label="路由地址" prop="uri" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.uri" class="widthPx-150" placeholder="路由地址" />
      </el-form-item>
      <el-form-item label="审核的参数,多个‘,’分隔" prop="params" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.params" class="widthPx-150" placeholder="审核的参数" />
      </el-form-item>
      <el-form-item label="参数类型(text、image),多个‘,’分隔" prop="type" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.type" class="widthPx-150" placeholder="参数类型" />
      </el-form-item>
      <el-form-item label="请求方法" prop="method" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.method" class="widthPx-150" placeholder="请求方法" />
      </el-form-item>
      <el-form-item label="请求参数类型" prop="contentType" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.contentType" class="widthPx-150" placeholder="请求参数类型" />
      </el-form-item>
    </el-form>
    <template #footer>
