<template>
  ...
  <!--     <el-button type="primary" @click="multiDelBtnClick">
    ...
    >
      ...
      <el-table-column align="center" prop="uri" label="路由地址" />     
      <el-table-column align="center" prop="params" label="审核参数(多个用‘,’分隔)" />
      <el-table-column align="center" prop="type" label="审核类型(多个用‘,’分隔)" />
      <el-table-column align="center" prop="method" label="请求方法"/>
      <el-table-column align="center" prop="contentType" label="参数类型"/>
      <!--点击操作-->
    ...
    <el-dialog v-model="detailDialog" :title="dialogTitle" width="500px" :close-on-click-modal="false">
      ...
      <div class="detail-container rowBC">
        <div class="detail-container-item">审核类型：{{ detailData.checkType }}</div>
      </div>
      <div class="detail-container rowBC">
        <div class="detail-container-item">审核参数(多个用‘,’分隔)：{{ detailData.checkParams }}</div>
      </div>
      <template #footer>
