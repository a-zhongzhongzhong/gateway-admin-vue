<template>
  ...
  >
    <el-form ref="refForm" label-width="150px" :inline="false" :model="subForm" :rules="formRules" class="pr-5">
      <el-form-item label="路由地址" prop="route" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.route" class="widthPx-150" placeholder="路由地址" />
      </el-form-item>
      ...
      <el-form-item label="过期时间(-1为永不过期)/单位秒" prop="expireTime" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.expireTime" class="widthPx-150" type="number" placeholder="过期时间" />
      </el-form-item>
    </el-form>
    <template #footer>
