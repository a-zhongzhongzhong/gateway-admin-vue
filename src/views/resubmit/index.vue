<template>
  <div class="scroll-y">
    ...
    >
      ...
      <el-table-column align="center" prop="url" label="路由地址" />     
      <el-table-column align="center" prop="params" label="校验参数" />
      <el-table-column align="center" prop="method" label="请求方法" />      
      <el-table-column align="center" prop="contentType" label="请求参数类型"/>
      <el-table-column align="center" prop="expireTime" label="过期时间(时间限制,间隔几秒不能再次提交)"/>
      <!--点击操作-->
    ...
    <el-dialog v-model="detailDialog" :title="dialogTitle" width="500px" :close-on-click-modal="false">
      ...
      <div class="detail-container rowBC">
        <div class="detail-container-item">校验参数：{{ detailData.checkParmas }}</div>
      </div>
      <div class="detail-container rowBC">
        <div class="detail-container-item">时间(单位秒,几秒内可提交一次)：{{ detailData.time }}</div>
      </div>
      <div class="detail-container rowBC">
        <div class="detail-container-item">次数：{{ detailData.count }}</div>
      </div>
      <template #footer>
